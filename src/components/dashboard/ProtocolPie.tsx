...
import { PieChart } from "lucide-solid";
...
export default function ProtocolPie(props: Props) {
  const total = () => props.data().reduce((s, p) => s + p.traffic, 0);
        ...
        <Show
          ...
          fallback={
            <div class="flex flex-col items-center justify-center py-12">
              <PieChart size={32} style={{ color: "#999" }} />
              <span style={{ "font-size": "14px", color: "#999", "margin-top": "12px" }}>暂无协议数据</span>
            </div>
          }
        >
